...
import { ArrowLeft, PenLine, Phone, Trash2, ChevronDown, ChevronUp, Settings, MessageSquare, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="unified-header">
      ...
      <div className="header-desktop-compact">
        <div className="header-container-compact">
          ...
          <div className="status-badges-container">
            <span className={`status-badge-header ${getStatusClass(formData.status)}`}>
              {formData.status === 'InProgress' ? 'IN PROGRESS' :
                formData.status === 'NoAnswer' ? 'NO ANSWER' : formData.status.toUpperCase()}
            </span>
          ...
          <div className="action-buttons-grid">
            ...
            <button
              onClick={() => onUpdate && onUpdate(lead)}
              className="btn-header-action btn-update-header"
              title="Update Lead"
            >
              <PenLine size={16} />
            </button>
      ...
      <div className="header-mobile-rows">
        {/* Row 1: Back Button + Lead Name + Pagination */}
        <div className="header-row-1">
          <div className="header-container">
            ...
            {totalLeads > 0 ? (
              <div className="header-pagination mobile-pagination">
                <button
                  className="btn-pagination"
                  onClick={onPrev}
                  disabled={!hasPrev}
                ...
                >
                  ...
                  {teamMembers.map(member => (
                    ...
                    >
                      ...
                      {!member.hasAccount ? ' (not attached)' : ''}
                    </option>
                  ))}
                </select>
              </div>
